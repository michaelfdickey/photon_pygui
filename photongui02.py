...
button00["name"] = "exit"
button00["origin_x"] = 0
button00["origin_y"] = pygame_window_height - 20
button00["width"] = UI_sideBar_width
button00["height"] = 20
button00["label_txt"] = "EXIT"
button00["type"] = "pushy"
button00["enabled"] = True
button00["color"] = UI_button_color
button00["group"] = "button00"
button00["visible"] = True

button01 = {}
button01["name"] = "command01"
button01["origin_x"] = 0
button01["origin_y"] = pygame_window_height - 60
button01["width"] = UI_sideBar_width
button01["height"] = 20
button01["label_txt"] = "Command 01"
button01["type"] = "pushy"
button01["enabled"] = True
button01["color"] = UI_button_color
button01["group"] = "command01"
button01["visible"] = True

button02 = {}
button02["name"] = "command02"
button02["origin_x"] = 0
button02["origin_y"] = pygame_window_height - 80
button02["width"] = UI_sideBar_width
button02["height"] = 20
button02["label_txt"] = "Command 02"
button02["type"] = "pushy"
button02["enabled"] = True
button02["color"] = UI_button_color
button02["group"] = "command02"
button02["visible"] = True

button03 = {}
button03["name"] = "command03"
button03["origin_x"] = 0
button03["origin_y"] = pygame_window_height - 100
button03["width"] = UI_sideBar_width
button03["height"] = 20
button03["label_txt"] = "Command 03"
button03["type"] = "pushy"
button03["enabled"] = True
button03["color"] = UI_button_color
button03["group"] = "command03"
button03["visible"] = True

button04 = {}
button04["name"] = "sticky01"
button04["origin_x"] = 0
button04["origin_y"] = pygame_window_height - 160
button04["width"] = UI_sideBar_width
button04["height"] = 20
button04["label_txt"] = "Sticky 01"
button04["type"] = "sticky"
button04["enabled"] = False
button04["color"] = UI_button_color
button04["group"] = "sticky01"
button04["visible"] = True

button05 = {}
button05["name"] = "sticky02"
button05["origin_x"] = 0
button05["origin_y"] = pygame_window_height - 180
button05["width"] = UI_sideBar_width
button05["height"] = 20
button05["label_txt"] = "Sticky 02"
button05["type"] = "sticky"
button05["enabled"] = False
button05["color"] = UI_button_color
button05["group"] = "sticky02"
button05["visible"] = True

button06 = {}
button06["name"] = "sticky03"							# button_name
button06["origin_x"] = 0								# button_origin_x
button06["origin_y"] = pygame_window_height - 200		# button_origin_y
button06["width"] = UI_sideBar_width					# button_width
button06["height"] = 20								# button_height
button06["label_txt"] = "Sticky 03"					# button_label_txt
button06["type"] = "sticky"							# buttonType
button06["enabled"] = False							# buttonEnabled
button06["color"] = UI_button_color 					# buttonColor
button06["group"] = "sticky03"						# buttonGroup
button06["visible"] = True							# buttonVisible

button07 = {}
button07["name"] = "pushy_label"
button07["origin_x"] = 0
button07["origin_y"] = pygame_window_height - 120
button07["width"] = UI_sideBar_width
button07["height"] = 20
button07["label_txt"] = "Pushy Buttons"
button07["type"] = "label"
button07["enabled"] = True
button07["color"] = UI_label_color
button07["group"] = "pushy_buttons"
button07["visible"] = True

button08 = {}
button08["name"] = "sticky_label"
button08["origin_x"] = 0
button08["origin_y"] = pygame_window_height - 220
button08["width"] = UI_sideBar_width
button08["height"] = 20
button08["label_txt"] = "Sticky Buttons"
button08["type"] = "label"
button08["enabled"] = True
button08["color"] = UI_label_color
button08["group"] = "sticky_buttons"
button08["visible"] = True

button09 = {}
button09["name"] = "group01_label"					# button_name
button09["origin_x"] = 0								# button_origin_x
button09["origin_y"] = pygame_window_height - 300		# button_origin_y
button09["width"] = UI_sideBar_width					# button_width
button09["height"] = 20								# button_height
button09["label_txt"] = "Group 01"						# button_label_txt
button09["type"] = "label"							# buttonType
button09["enabled"] = False							# buttonEnabled
button09["color"] = UI_label_color 					# buttonColor
button09["group"] = "group01"						# buttonGroup
button09["visible"] = True							# buttonVisible
...
button10["height"] = 20								# button_height
...
button11["height"] = 20								# button_height
...
allButtons["origin_x"] = button01		# command 01
allButtons["origin_y"] = button02		# command 02
allButtons["width"] = button03		# command 03
allButtons["height"] = button04		# sticky 01
allButtons["label_txt"] = button05		# sticky 02
allButtons["type"] = button06		# sticky 03
allButtons["enabled"] = button07		# pushy button group label
allButtons["color"] = button08		# stick button group label
allButtons["group"] = button09		# group01 label
allButtons["visible"] = button10 	# group01 button 01
			...
			if selected_button != None:
				...
				if selected_button.buttonType == "pushy":
					...
					if selected_button.button_name == "command01":
						...
						button01["enabled"] = True
						button01["color"] = UI_button_click_color
						defineButtons()
					...
					if selected_button.button_name == "command02":
						...
						button02["enabled"] = True
						button02["color"] = UI_button_click_color
						defineButtons()
					...
					if selected_button.button_name == "command03":
						...
						button03["enabled"] = True
						button03["color"] = UI_button_click_color
						defineButtons()
